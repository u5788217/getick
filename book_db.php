	...
	switch ($roundid) {
		case 1:case 2:case 6:case 10:case 14:case 15:
					...
					case 2:case 4:case 6:case 8:
							...
							if($j%14==0 && $j<56) {echo '<td colspan="1"></td><tr><td colspan="1"></td>';}
						}
					    	echo '</tr>'; break;
                        		case 5:
                            			echo '<tr><td colspan="1"></td>';
						foreach ($oConn->query("SELECT * FROM seat WHERE id_zone = '$zoneid[1]'") as $aRow) {
							...
							if($j%16==0 && &j<96){echo '<td colspan="1"></td><tr><td colspan="1"></td>';}
                            			}	
                            			echo '</tr>'; break;
                        		case 7:
                            			echo '<tr><td colspan="1"></td>';
							...
							if($j%18==0 && $j<90){echo '<td colspan="1"></td><tr><td colspan="1"></td>';}
                            			}
                            			echo '</tr>'; break;                         
                      		}//for switch
			}//for i++;
