		...
		case 1:case 2:case 6:case 10:case 14:case 15:
					...
					case 2:case 4:case 6:case 8:
							...
							if($aRow['id_booking'] == NULL){
								echo '<td id="A">A'.$aRow['id_seat'].'<br><input type="checkbox" value="'.$aRow['id_seat'].' '.$zoneid[0].'" onchange="showCheck(this.value)" ></td>';
							} 
						...
						foreach ($oConn->query("SELECT * FROM seat WHERE id_zone = '$zoneid[1]'") as $aRow) {
							...
							if($aRow['id_booking'] == NULL){
								echo '<td id="B">B'.$aRow['id_seat'].'<br><input type="checkbox" value="'.$aRow['id_seat'].' '.$zoneid[1].'" onchange="showCheck(this.value)" ></td>';
							}   
							...
							$j=$aRow['id_seat'];
							if($aRow['id_booking'] == NULL){
								echo '<td id="C">C'.$aRow['id_seat'].'<br><input type="checkbox" value="'.$aRow['id_seat'].' '.$zoneid[2].'" onchange="showCheck(this.value)" ></td>';							
}
